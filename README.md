...
## LLMs & Finance
- [AI4Finance-Foundation/FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) — FinGPT: Open-Source Financial Large Language Models. Trained models and tools for finance-focused LLM workflows. — Stars: 21061 — Snapshot: 2026-08-09
- [AI4Finance-Foundation/FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) — FinRobot: Open-Source AI Agent Platform for Financial Applications using LLMs. — Stars: 7757 — Snapshot: 2026-08-09
...
- [freqtrade/freqtrade](https://github.com/freqtrade/freqtrade) — Free, open-source crypto trading bot (strategy backtesting, live trading). — Stars: 53094 — Snapshot: 2026-08-09
- [hajime-f/stocktrading](https://github.com/hajime-f/stocktrading) — 機械学習を応用した日本株の自動売買プログラム (ML-based automated trading for Japanese stocks). — Stars: 10 — Snapshot: 2026-08-09

## Market Data & Broker APIs
- [shirasublue/python-kabusapi](https://github.com/shirasublue/python-kabusapi) — kabu STATION API bindings for Python. — Stars: 17 — Snapshot: 2026-08-09
- [kabucom/kabusapi](https://github.com/kabucom/kabusapi) — kabuステーションAPI ポータル (official docs/portal). — Stars: 431 — Snapshot: 2026-08-09
- [hajime-f/stocks_us](https://github.com/hajime-f/stocks_us) — 米国株式の情報を集めるスクリプト (US stock data collection scripts). — Stars: 1 — Snapshot: 2026-08-09

## Quant / Market Analysis / Simulation
- [YH-05/quants](https://github.com/YH-05/quants) — 金融市場分析用プロジェクト (project for financial market analysis). — Stars: 1 — Snapshot: 2026-08-09
- [highperformancecoder/minsky](https://github.com/highperformancecoder/minsky) — Systems dynamics economics modeling software. — Stars: 375 — Snapshot: 2026-08-09
- [TechNavii/timeseries_for_fun](https://github.com/TechNavii/timeseries_for_fun) — Time series experiments and examples. — Stars: 3 — Snapshot: 2026-08-09
